  ...
  <main>
    <section id="text">
      ...
      <article id="text__details">
        <header><h2>Details / Summary</h2></header>
        <details>
    ...
    <section id="embedded">
      ...
      <article id="embedded__images">
        ...
        <div>
          ...
          <figure><img src="https://picsum.photos/420/420" alt="Photo"></figure>
          <h3><code>&lt;figure&gt;</code> element with <code>&lt;img&gt;</code> and <code>&lt;figcaption&gt;</code> elements</h3>
          <figure>
            <img src="https://picsum.photos/420/420" alt="Photo">
    ...
    <section id="forms">
      ...
      <form>
        ...
        <fieldset id="forms__html5">
          ...
          <p>
            <label for="idt">Time input</label>
            <input type="time" id="idt" name="idt" min="00:00" max="24:00">
          </p>
          <p>
